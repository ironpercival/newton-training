...
namespace NewtonTraining {
	...
	public static class PersonsHelper {
		public static Person[] Sort(Person[] persons) {
			var sortedPersons = new Person[persons.Length];
		...
		public static Person[] RemoveDuplicates(Person[] persons) {
			throw new NotImplementedException();
			// do remove duplicates here			
		}

		public static string ToString(Person[] persons) {
